...
.vectabstart
	EQUW BASIN		; FFCF RDT INPUT LINE
	EQUW BSOUT		; FFD2 WRT/PUT
	EQUW GETIN		; FFE4 GET CHR FROM KEYBOARD BUFFER

	;EQUW OPEN		; FFC0 OPEN FILE
	;EQUW CLOSE		; FFC3 CLOSE FILE
	;EQUW CHKIN		; FFC6 GET FROM CHANNEL
	;EQUW CKOUT		; FFC9 PUT TO CHANNEL
	;EQUW CLRCH		; FFCC CLOSE CHANNEL
	;EQUW CLALL		; FFE7 CLOSE ALL
.vectabend
...
.POKADJ
	...
	; PEEK ADDRESS, WHERE ADDRESS >= $8000
	; Y=0
.*KPEEK
	JSR POKADJ
	JMP GETCON
	...
	; POKE ADDRESS, WHERE ADDRESS >= $8000
	; X = VALUE
.*KPOKE
	LDY POKER+1
	CPY #HI(&8000+1000)
...
.KP4
	...
	CMP #&05
	BCS KP3	;IF NOT VIA, OR NOT SUPPORTED
	
	; VIA REGISTERS:
	; R8 T2-L, R9 T2-H, R10 SR, R11 ACR, R12 PCR

	TAY	; 0 <= Y <= 4
	TXA
	JMP POKEVIA	;Y = REGISTER-8, A = VALUE
}
.KERNAL_END
